...
# Si train_final.csv y test_final.csv ya existen en 00_data/processed/,
# se omite este paso. Los archivos procesados están incluidos en el repo
# y no es necesario tener credenciales de Google Cloud para reproducir.
train_final = BASE / "00_data" / "processed" / "train_final.csv"
